...
/*
    ...
    *********************************************************************************************************/
CREATE PROCEDURE dbo.usp_MergeTurbulenceData
(
	@TurbulenceDataId		INTEGER = NULL
...
BEGIN
	...
	SET @TranCount = 1
END
ELSE SAVE TRANSACTION usp_MergeTurbulenceDataTran

	IF @TurbulenceDataId IS NULL 
	BEGIN
...
BEGIN CATCH
	...
	IF @TranCount=1
		ROLLBACK
	ELSE
	ROLLBACK TRANSACTION usp_MergeTurbulenceDataTran
