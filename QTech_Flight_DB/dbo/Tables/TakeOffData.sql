CREATE TABLE dbo.TakeOffData
(
	TakeOffDataId			INTEGER IDENTITY(1,1)		NOT NULL
	...
	, Method				NVARCHAR(5)					NULL CONSTRAINT DF_TakeOffData_Method DEFAULT 'Pupil'
	, Gaze_Point_3d_X		DECIMAl(15,12)				NULL
	, Gaze_Point_3d_Y		DECIMAL(15,12)				NULL
	, Gaze_Point_3d_Z		DECIMAL(15,12)				NULL
	, DateInserted			DATETIME					NULL CONSTRAINT DF_TakeOffData_DateInserted DEFAULT GETDATE()
	, CONSTRAINT PK_TakeOffData_TakeOffDataId PRIMARY KEY (TakeOffDataId)
)
