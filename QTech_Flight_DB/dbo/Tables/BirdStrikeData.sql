CREATE TABLE dbo.BirdStrikeData
(
	BirdStrikeDataId		INTEGER IDENTITY(1,1)		NOT NULL
	...
	, Method				NVARCHAR(5)					NULL CONSTRAINT DF_BirdStrikeData_Method DEFAULT 'Pupil'
	, Gaze_Point_3d_X		DECIMAl(15,12)				NULL
	, Gaze_Point_3d_Y		DECIMAL(15,12)				NULL
	, Gaze_Point_3d_Z		DECIMAL(15,12)				NULL
	, DateInserted			DATETIME					NULL CONSTRAINT DF_BirdStrikeData_DateInserted DEFAULT GETDATE()
	, CONSTRAINT PK_BirdStrikeData_BirdStrikeDataId PRIMARY KEY (BirdStrikeDataId)
)
