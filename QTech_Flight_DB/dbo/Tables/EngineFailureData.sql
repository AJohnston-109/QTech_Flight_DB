CREATE TABLE dbo.EngineFailureData
(	
	EngineFailureDataId		INTEGER IDENTITY(1,1)		NOT NULL
	...
	, Method				NVARCHAR(5)					NULL CONSTRAINT DF_EngineFailureData_Method DEFAULT 'Pupil'
